        ...
        return {
            ...
            'فیتامین': {
                'variations': [
                    ...
                    'فیتامین', 'فيتامين', 'ویتامین', 'فیت', 'فیتا', 'فیتامن', 'فتامین', 
                    'فایتامین', 'فایتمین', 'فتمین', 'فیتمین', 'فیامین', 'فیتامینات',
                    
                    # Key compounds - Arabic
                    'فیتامین سی', 'فیتامین د', 'فیتامین دال', 'فیتامین ب', 'فیتامین بی12',
                    'فیتامین د3', 'فیتامین k2', 'مالتی فیتامین', 'ملتی فیتامین',
                    'فیتامین للاطفال', 'فیتامین اطفال', 'فیتامین للشعر', 'فیتامین شعر',
                    'فیتامین د 50000', 'فیتامین د 5000', 'فیتامین سی فوار', 'شراب فیتامین',
                    'حبوب فیتامین', 'قطرات فیتامین', 'فیتامین للرجال', 'فیتامین للنساء',
                    'فیتامین حمل', 'فیتامین الحمل', 'فیتامینات حمل', 'فیتامین سنتروم',
                    
                    # Core English variations  
                    'vitamin', 'vitamins', 'multivitamin', 'multivitamins', 'multi vitamin',
                    'vitamin c', 'vitamin d', 'vitamin d3', 'vitamin b', 'vitamin b12',
                    'vitamin e', 'vitamin k2', 'vitamin d3 k2', 'prenatal vitamin',
                    'hair vitamin', 'kids vitamin', 'vitamin d 50000', 'vitamin d 5000',
                    'vitamin c 1000', 'multivitamin men', 'multivitamin women',
                    'pregnancy vitamins', 'vitamin drops', 'centrum multivitamins'
                ],
                'excluded_terms': [
                ...
                'compounds': [
                    # Dosages & types
                    '50000', '5000', '10000', '1000', '500', 'd3', 'k2', 'b12', 'سی', 'د', 'ب',
                    # Target groups & forms
                    'للاطفال', 'اطفال', 'للرجال', 'للنساء', 'حمل', 'شعر', 'فوار', 'حبوب', 'شراب', 'قطرات'
                ],
                'threshold': 80,
                'min_length': 4
            }
            ...
            'میلاتونین': {
                'variations': [
                    ...
                    'میلاتونن', 'ملاتونن', 'ميلاتونين', 'میلاتون', 'میلات', 'میلا',
                    'میلانونین', 'میلتونین', 'میلجا', 'میلاتی', 'میلانین', 'میل',
                    'میلاتیون', 'میلاتینون', 'میلاتنین', 'میلاتنون', 'مسلاتونین'
                ],
                'compounds': [
                    '3mg', '5mg', '10mg', '3', '5', '10', '1', 'اطفال', 'للاطفال',
                    'کیدز', 'kids', 'gummies', 'حلوى', 'نقط', 'شراب'
                ],
                'threshold': 80,
                'min_length': 4
            },
            
            'اوميجا': {  # Fixed key name
                'variations': [
                    'اومیجا', 'اومیغا', 'اومیقا', 'اوم', 'اومی', 'اومیج', 'اومج',
                    'اومقا', 'اومغا', 'اوکیقا', 'میجا', 'میج', 'اوکیغا', 'اوکیجا',
                    'امیغا', 'امیقا', 'اومق', 'اویجا', 'اومجیا', 'میغا', 'امیغا',
                    'اویغا', 'اومیجانا', 'ارمیغا', 'کومی', 'اونیغا', 'omega'
                ],
                'compounds': [
