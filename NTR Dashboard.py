        ...
        return {
            ...
            'فیتامین': {
                'variations': [
                    ...
                    'ویت', 'فیتا', 'فیتامن', 'فيتامن', 'فتامین', 'فایتامین', 'فتام',
                    'فایتمین', 'فایتمن', 'فتمین', 'فینامین', 'فیتمین', 'فیامین'
                ],
                'compounds': [
                    'د', 'د3', 'ب12', 'ب', 'سی', 'c', 'd', 'd3', 'b12', 'b', 'e', 'k2',
                    '50000', '5000', '10000', '1000', 'للاطفال', 'اطفال'
                ],
                'threshold': 75,
                'min_length': 3
            },
